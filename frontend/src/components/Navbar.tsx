...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-ink border-b border-ridge transition-colors duration-300">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button onClick={() => setMobileOpen(!mobileOpen)} className="text-chalk p-1">
